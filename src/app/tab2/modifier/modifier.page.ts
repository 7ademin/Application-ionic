...
export class ModifierPage implements OnInit {
  ...
  constructor(private builder: FormBuilder, private route: ActivatedRoute,
    private nav : NavController, private service: PlatsService, private router : Router, restauApi: RestaurantService) {
    ...
    this.service.getPlat(this.platId).subscribe(plat => {
      ...
      this.restaurantControl = new FormControl(this.plat.restaurant);
